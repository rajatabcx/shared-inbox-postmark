    ...
    return (
      ...
      >
        <div
          ...
          dir={dir}
          className={cn(
            'flex items-center gap-1 p-1 rounded-lg bg-transparent overflow-hidden overflow-x-auto ring-none w-full no-scrollbar',
            {
          ...
          {value.map((item, index) => (
            <Badge
              ...
              className={cn(
                ...
                'hover:bg-destructive/20 hover:text-destructive hover:border-destructive cursor-pointer'
              )}
              variant={'secondary'}
